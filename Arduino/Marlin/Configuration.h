...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 211.95
    #define  DEFAULT_bedKi 34.50
    #define  DEFAULT_bedKd 325.55
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -0.2 // - -> se stampa troppo in alto (effetto -> abbassa)  + -> se stampa troppo in basso (effetto -> alza)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.88,80.32,2561.16,97.81}  // MXL, Z M8=1.25, MK8
